...
def parse_args():
    ...
    parser.add_argument("--masks_path", type=str, help="Path to the HistoQC masks location", required=True)
    ...
    deepliif_parser.add_argument("--tile_size", type=str, help="Size of the tiles to be processed", default=512)
